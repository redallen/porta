...
module Liquid
  module Drops
    class Provider < Drops::Base
      ...
      def api_specs
        service_api_specs = @model.all_api_docs.accessible(::Service)
        account_api_specs = @model.all_api_docs.accessible(::Account)
        backend_api_api_specs = @model.all_api_docs.accessible(::BackendApi)
        accessible_api_specs = ApiDocs::Service.where(id: service_api_specs | account_api_specs | backend_api_api_specs)

        # [Deprecated][TODO] remove with service_id
        deprecated_service_api_specs = @model.all_api_docs.where.not(service_id: nil).deprecated_service_accessible
