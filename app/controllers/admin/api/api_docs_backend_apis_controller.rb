...
class Admin::Api::ApiDocsBackendApisController < Admin::Api::BaseController
  ...
  ##~ e = sapi.apis.add
  ##~ e.path = "/admin/api/backend_api_active_docs.json"
  ...
  ##~ sapi = source2swagger.namespace("Account Management API")
  ##~ e = sapi.apis.add
  ##~ e.path = "/admin/api/backend_api_active_docs/{id}.json"
  ##~ e.responseClass = "backend_api_active_doc"
  #
  ##~ op            = e.operations.add
  ##~ op.httpMethod = "PUT"
  ...
  def api_docs
    current_account.api_docs.owned_by_backend_api
  end
  ...
  def api_docs_params(*extra_params)
    ...
    backend_api_id = permitted_params.delete(:backend_api_id)
    permitted_params[:owner_id] = backend_api_id if backend_api_id.present?
